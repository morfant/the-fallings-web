...
// modDepth = 300 × mul 0.4. amp: 원문 0.1 → 1/3 → ×1.5 = 0.05 (2026-09-19) → ×2 = 0.1 (작가 조율 2026-09-20, 폰 실청 뒤 — 원문 크기로 복귀).
const ACK_PING = { fLo: 600, fHi: 700, modDepth: 300 * 0.4, modLfo: 250, att: 0.1, rel: 1.0, amp: 0.1,
    krRate: 44100 / 64 };
